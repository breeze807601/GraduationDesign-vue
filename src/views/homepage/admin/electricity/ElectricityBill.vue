<template>
    <div>
        <el-row>
            ...
            <el-col :span="24">
                <el-tooltip content="导出用电账单" effect="light">
...
import {Search, Refresh, Plus, Download, Bell, EditPen} from '@element-plus/icons-vue';
...
async function download() {
    ...
    await request.get('/electricityBill/export',{
        ...
        link.href = url;
        link.setAttribute('download', '用电账单.xlsx'); // 设置下载文件名
